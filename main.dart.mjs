...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1267: x0 => globalThis.URL.revokeObjectURL(x0),
      _1268: x0 => x0.remove(),
      _1269: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      _1270: x0 => globalThis.URL.createObjectURL(x0),
      _1271: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1271(f,arguments.length,x0) }),
      _1272: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      ...
      _1279: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1280: (x0,x1) => x0.replaceChildren(x1),
      _1281: x0 => x0.click(),
      ...
      _1318: (x0,x1,x2) => x0.close(x1,x2),
      _1319: (x0,x1) => x0.close(x1),
      _1320: x0 => x0.close(),
      _1322: (x0,x1) => x0.send(x1),
      _1323: x0 => x0.decode(),
      ...
      _1463: (x0,x1) => new WebSocket(x0,x1),
      _1464: () => new AbortController(),
      _1465: x0 => x0.abort(),
      _1466: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1467: (x0,x1) => globalThis.fetch(x0,x1),
      _1468: (x0,x1) => x0.get(x1),
      _1469: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1469(f,arguments.length,x0,x1,x2) }),
      _1470: (x0,x1) => x0.forEach(x1),
      _1471: x0 => x0.getReader(),
      _1472: x0 => x0.read(),
      _1473: x0 => x0.cancel(),
      _1477: x0 => x0.send(),
      _1479: () => new FileReader(),
      ...
      _1491: (x0,x1) => x0.appendChild(x1),
      _1495: (x0,x1) => x0.item(x1),
      _1498: (x0,x1) => x0.getContext(x1),
      _1502: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      _1504: (s, m) => {
        try {
      ...
      _1667: (x0,x1) => { x0.responseType = x1 },
      _1668: x0 => x0.response,
      _1744: x0 => x0.style,
      _1757: (x0,x1) => { x0.oncancel = x1 },
      _1763: (x0,x1) => { x0.onchange = x1 },
      _1803: (x0,x1) => { x0.onerror = x1 },
      _2176: (x0,x1) => { x0.src = x1 },
      _2187: x0 => x0.width,
      _2189: x0 => x0.height,
      _2221: (x0,x1) => { x0.src = x1 },
      _2668: (x0,x1) => { x0.accept = x1 },
      _2682: x0 => x0.files,
      _2708: (x0,x1) => { x0.multiple = x1 },
      _2726: (x0,x1) => { x0.type = x1 },
      _2975: x0 => x0.src,
      _2976: (x0,x1) => { x0.src = x1 },
      _2978: (x0,x1) => { x0.type = x1 },
      _2982: (x0,x1) => { x0.async = x1 },
      _2996: (x0,x1) => { x0.charset = x1 },
      _3020: x0 => x0.width,
      _3021: (x0,x1) => { x0.width = x1 },
      _3022: x0 => x0.height,
      _3023: (x0,x1) => { x0.height = x1 },
      _3444: () => globalThis.window,
      _3506: x0 => x0.navigator,
      _3770: x0 => x0.localStorage,
      _3882: x0 => x0.maxTouchPoints,
      _3891: x0 => x0.appVersion,
      _3892: x0 => x0.platform,
      _3895: x0 => x0.userAgent,
      _3896: x0 => x0.vendor,
      _3946: x0 => x0.data,
      _3947: x0 => x0.origin,
      _4321: x0 => x0.readyState,
      _4334: (x0,x1) => { x0.binaryType = x1 },
      _4337: x0 => x0.code,
      _4338: x0 => x0.reason,
      _6005: x0 => x0.type,
      _6006: x0 => x0.target,
      _6046: x0 => x0.signal,
      _6058: x0 => x0.length,
      _6118: () => globalThis.document,
      _6200: x0 => x0.body,
      _6202: x0 => x0.head,
      _6531: (x0,x1) => { x0.id = x1 },
      _6558: x0 => x0.children,
      _7877: x0 => x0.value,
      _7879: x0 => x0.done,
      _8059: x0 => x0.size,
      _8060: x0 => x0.type,
      _8067: x0 => x0.name,
      _8068: x0 => x0.lastModified,
      _8073: x0 => x0.length,
      _8079: x0 => x0.result,
      _8576: x0 => x0.url,
      _8578: x0 => x0.status,
